...
export const REASON_CODE_TO_ORIGIN: Record<string, FailureOrigin> = {
  ...
  [SQL_VERIFICATION_OUTCOME_CODE.RELATED_ROWS_ABSENT]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.RELATIONAL_EXPECTATION_MISMATCH]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.RELATIONAL_SCALAR_UNUSABLE]: DOWNSTREAM,
  ...
  [SQL_VERIFICATION_OUTCOME_CODE.ROW_PRESENT_WHEN_FORBIDDEN]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.ORPHAN_ROW_DETECTED]: DOWNSTREAM,
  [SQL_VERIFICATION_OUTCOME_CODE.FORBIDDEN_ROWS_STILL_PRESENT_WITHIN_WINDOW]: DOWNSTREAM,
