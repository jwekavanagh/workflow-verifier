...
- **`/integrate` route:** [`website/src/app/integrate/page.tsx`](../website/src/app/integrate/page.tsx) renders **static** activation copy from [`website/src/content/productCopy.ts`](../website/src/content/productCopy.ts) (`integrateActivation`, optional registry-draft copy) and [`website/src/content/siteMetadata.ts`](../website/src/content/siteMetadata.ts), plus a small client `RegistryDraftPanel` for the optional draft helper. It does **not** import **`integratorDocsEmbedded`** at build or runtime.
